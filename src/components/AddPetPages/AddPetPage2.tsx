...
const AddPetPage2 = () => {
    ...
    return (
        <div className="page-2">
            <label className='input-label'>{t("nameQuestion")}</label>
            <input type='text' value={pet.name} onChange={(e) => updateName(e.target.value)}/>
            <div className='gender-buttons-container'>
                <button className={pet.isMale ? "gender-button selected" : "gender-button"} onClick={() => updateSex(true)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="78" height="78" fill="currentColor" viewBox="-5 -5 26 26">
